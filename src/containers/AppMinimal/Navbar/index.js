...
import { MENU_ITEMS } from 'src/common/src/data/AppMinimal';
import ScrollSpyMenu from 'src/common/src/components/ScrollSpyMenu';

import LogoImage from 'src/common/src/assets/image/app-minimal/header-logo.svg';
import LogoImageStick from 'src/common/src/assets/image/app-minimal/header-logo-stick.svg';
