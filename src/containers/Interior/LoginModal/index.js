...
import CheckBox from 'src/common/src/components/Checkbox/index';
import Button from 'src/common/src/components/Button';
import Image from 'src/common/src/components/Image';
import LoginModalWrapper from './loginModal.style';
import 'rc-tabs/assets/index.css';
import LogoImage from 'src/common/src/assets/image/interior/logo.png';
import LoginImage from 'src/common/src/assets/image/interior/login-bg.jpg';
import GoogleLogo from 'src/common/src/assets/image/interior/google-icon.jpg';
